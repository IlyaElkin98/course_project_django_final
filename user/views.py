...
from mailings.models import Campaign, Subscriber

from user.forms import CustomUserCreationForm, UserPasswordChangeForm, UserProfileForm, VerificationCodeForm
from user.models import CustomUser, TemporaryUser
...
class UserProfileEditView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            form.save()
            return redirect("user:user_profile")  # Укажите свой URL для перенаправления после редактирования профиля
        return render(request, "user/edit_profile.html", {"form": form})
...
class UserBlockView(LoginRequiredMixin, UserPassesTestMixin, View):
    ...
    def post(self, request, username):
        ...
        return redirect("user:user_detail", username=username)
...
class DeleteProfileView(LoginRequiredMixin, View):
    ...
    def post(self, request, username):
        ...
        return redirect("mailings:home")  # Перенаправление на главную страницу или другую страницу
